# Aplos NCA Documentation
 ...
 -  [Analysis configuration](./pk-analysis/config-dosing) settings for Aplos NCA
 -  [Data Cleaning](./data-cleaning/rule-add-column) rules for Aplos NCA
 -  Explanation of [results](./pk-analysis/config-outputs) provided by Aplos NCA
